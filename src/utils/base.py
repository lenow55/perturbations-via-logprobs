...
from src.config import AppSettings, ChatLLMConfig, EmbedLLMConfig, LLMConfig
...
async def calculate_similarity(
    ...
    reference_i = get_detailed_instruct(
        task_description="Это эталонный ответ. С ним сравнивают предполагаемый ответ для получения оценки правильности. Уделяй особое внимание датам, именам, понятиям.",
        query=reference,
    )
    answer_i = get_detailed_instruct(
        task_description="Это предполагаемый ответ. Его сравнивают с эталонным ответом для получения оценки правильности. Уделяй особое внимание датам, именам, понятиям.",
        query=answer,
    )
